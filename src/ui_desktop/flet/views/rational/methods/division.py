...
class RationalDivisionView(ft.View):
    def __init__(self):
        super().__init__()
        self.route = "/rational/division"
        self.appbar = ft.AppBar(title=ft.Text("Деление дробей"), bgcolor=ft.Colors.BROWN_700)
        ...
        self.controls = [
            ft.Column(
                [
                    ...
                    ft.ElevatedButton(text="Разделить", on_click=self.divide_fractions),
