...
class RationalMultiplicationView(ft.View):
    def __init__(self):
        super().__init__()
        self.route = "/rational/multiplication"
        self.appbar = ft.AppBar(title=ft.Text("Умножение дробей"), bgcolor=ft.Colors.BROWN_700)
        ...
        self.controls = [
            ft.Column(
                [
                    ...
                    ft.ElevatedButton(text="Умножить", on_click=self.multiply_fractions),
