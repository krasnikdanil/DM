...
class RationalAdditionView(ft.View):
    def __init__(self):
        super().__init__()
        self.route = "/rational/addition"
        self.appbar = ft.AppBar(title=ft.Text("Сложение дробей"), bgcolor=ft.Colors.BROWN_700)
        ...
        self.controls = [
            ft.Column(
                [
                    ...
                    ft.ElevatedButton(text="Сложить", on_click=self.add_fractions),
