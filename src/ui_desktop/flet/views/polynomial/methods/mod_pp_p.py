...
class PolynomialModPPView(ft.View):
    def __init__(self):
        super().__init__()
        self.route = "/polynomial/mod_pp_p"
        self.appbar = ft.AppBar(title=ft.Text("Остаток от деления P(x) на P(x)"), bgcolor=ft.Colors.GREEN_700)
        ...
        self.controls = [
            ft.Column(
                [
                    ...
                    ft.ElevatedButton(text="Найти остаток", on_click=self.modulo_polynomials),
