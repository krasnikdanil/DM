...
class PolynomialMulPQView(ft.View):
    def __init__(self):
        super().__init__()
        self.route = "/polynomial/mul_pq_p"
        self.appbar = ft.AppBar(title=ft.Text("Умножение P(x)*Q"), bgcolor=ft.Colors.GREEN_700)
        ...
        self.controls = [
            ft.Column(
                [
                    ...
                    ft.ElevatedButton(text="Умножить", on_click=self.multiply_polynomial_by_rational),
    ...
    def multiply_polynomial_by_rational(self, e):
        try:
