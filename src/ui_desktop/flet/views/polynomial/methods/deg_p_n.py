...
class PolynomialDegPNView(ft.View):
    def __init__(self):
        super().__init__()
        self.route = "/polynomial/deg_p_n"
        self.appbar = ft.AppBar(title=ft.Text("Степень многочлена"), bgcolor=ft.Colors.GREEN_700)
        ...
        self.controls = [
            ft.Column(
                [
                    ...
                    ft.ElevatedButton(text="Найти степень", on_click=self.get_polynomial_degree),
    ...
    def get_polynomial_degree(self, e):
        try:
